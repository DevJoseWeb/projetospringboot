...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Produto p10 = new Produto(null, "Pendente", 80.100);
		...
		Cidade c4 = new Cidade(null, "Campo Grande", est2);
		...
		Endereco e1 = new Endereco(null, "Rua Flores", "380", "Apto 303", "Jardim", "38220834", cli1, c2);
